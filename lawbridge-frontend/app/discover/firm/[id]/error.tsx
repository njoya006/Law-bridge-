...
export default function FirmDetailError({
  error,
  reset,
}: {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-16 px-4">
      <div className="rounded-xl border border-crimson-500/30 bg-crimson-900/10 p-8 text-center space-y-4">
        <h2 className="font-heading text-body-lg text-neutral-50">Could not load firm</h2>
        <p className="text-neutral-400 text-sm font-mono break-all">{error?.message ?? 'Unknown error'}</p>
