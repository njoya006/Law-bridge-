          ...
          <div className="max-w-xl space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="font-display text-4xl leading-tight text-neutral-50 sm:text-5xl lg:text-6xl">
                Sign in to the law firm workspace.
              </h1>
              <p className="max-w-2xl text-base leading-7 text-neutral-300 sm:text-lg">
                Use this login for partners, associates, and the secretary admin inside a law firm account.
              </p>
            </div>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur">
                ...
                <p className="text-sm text-neutral-300">Firm-wide matters and operations</p>
              </div>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur">
                <UserIcon className="mb-3 h-5 w-5 text-sky-300" />
                <p className="text-sm text-neutral-300">Role-based access for staff members</p>
              </div>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur">
                <CheckIcon className="mb-3 h-5 w-5 text-emerald-400" />
                <p className="text-sm text-neutral-300">Secretary can manage the workspace</p>
              </div>
            </div>
          </div>

          <p className="mt-10 text-sm text-neutral-400">
            Need to create a firm first?{' '}
            <Link href="/auth/law-firm" className="font-semibold text-gold-300 hover:text-gold-200">
              Start law-firm onboarding
            </Link>
          </p>
        </section>
        ...
        <section className="flex items-center px-6 pb-10 sm:px-10 lg:px-12 lg:py-14">
          <div className="w-full rounded-[2rem] border border-white/10 bg-white/8 p-6 shadow-2xl shadow-black/30 backdrop-blur-xl sm:p-8">
            <div className="mb-8 space-y-2">
              <p className="text-sm uppercase tracking-[0.28em] text-gold-300">Law firm login</p>
              <h2 className="font-display text-3xl text-neutral-50">Sign in</h2>
              <p className="text-sm leading-6 text-neutral-300">Enter your staff credentials to continue.</p>
            </div>
