    ...
    <main className="space-y-8 max-w-4xl w-full">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Add notes about your preferred communication style or support needs..."
              />
            </div>
      ...
      <Card className="p-8">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between p-4 border border-neutral-700/30 rounded-lg hover:border-neutral-600/50 transition-colors">
            <div>
              <p className="font-heading text-body-md text-neutral-50">Connected Devices</p>
              <p className="text-neutral-400 text-body-sm">Review devices signed into your client account</p>
            </div>
            <Button variant="outline" size="sm">
              View
            </Button>
      ...
      <Card className="p-8 border border-crimson-500/30">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between p-4 border border-crimson-500/20 rounded-lg">
            <div>
              <p className="font-heading text-body-md text-neutral-50">Logout from All Devices</p>
              <p className="text-neutral-400 text-body-sm">Sign out of every browser and device</p>
            </div>
            <Button variant="outline" size="sm">
              Logout All
            </Button>
