                ...
                <div key={doc.id} className="flex items-center gap-3 px-5 py-4 hover:bg-primary-700/20 transition-colors">
                  ...
                  <div className="flex flex-shrink-0 items-center gap-2">
                    <button
                      ...
                      className="min-h-[34px] rounded-lg border border-white/10 bg-white/5 px-3 py-1.5 text-xs font-medium text-neutral-300 hover:bg-white/10 hover:text-neutral-100 transition-colors"
                    >
                      Open
                    </button>
                    <button
                      onClick={() => void handleDownload(doc)}
                      className="min-h-[34px] flex items-center justify-center rounded-lg border border-gold-500/25 bg-gold-500/10 px-3 py-1.5 text-xs font-medium text-gold-400 hover:bg-gold-500/20 transition-colors"
                    >
