...
from .intelligence_views import CourtAnalyticsView, CaseStatsView
...
urlpatterns = [
    ...
    path('intelligence/court-analytics/', CourtAnalyticsView.as_view(), name='court-analytics'),
    path('stats/', CaseStatsView.as_view(), name='case-stats'),
