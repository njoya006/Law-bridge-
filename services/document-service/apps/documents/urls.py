...
from .views import DocumentUploadView, DocumentListView, DocumentDownloadView, SignDocumentView, DocumentDeleteView
...
urlpatterns = [
    ...
    path('<uuid:document_id>/delete/', DocumentDeleteView.as_view(), name='document-delete'),
